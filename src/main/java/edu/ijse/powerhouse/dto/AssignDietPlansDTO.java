...
public class AssignDietPlansDTO {
    ...
    public AssignDietPlansDTO() {
    }

    public AssignDietPlansDTO(String member_id, String diet_plan_id, String assigned_date, String end_date, String notes, String assigned_by) {
