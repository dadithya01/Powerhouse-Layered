...
public class AssignWorkoutPlansTM {
    ...
    public AssignWorkoutPlansTM() {
    }

    public AssignWorkoutPlansTM(String member_id, String workout_plan_id, String assigned_date, String end_date, String progress, String notes, String assigned_by) {
