...
public class AssignWorkoutPlans {
    ...
    public AssignWorkoutPlans() {
    }

    public AssignWorkoutPlans(String member_id, String workout_plan_id, String assigned_date, String end_date, String progress, String notes, String assigned_by) {
